...
public class CloudSimTagsExt {
	...
	/**
	 * Denotes an available resources request to datacenter
	 */		
	public static final int AVAILABLE_RESOURCE_REQUEST = BASEEDGE + 21;
	/**
	 * Denotes an available resources answer to user
	 */			
	public static final int AVAILABLE_RESOURCE = BASEEDGE + 22;
	
	public static final long DATA_SIZE = 10; // 10 KB
