...
public class CustomLog {
	...
	public static final String FILE_SERVICE_STREAMING_PATH_PROP_KEY = "serviceStreamingFilePath";
	public static final String FILE_SERVER_USAGE_PATH_PROP_KEY = "ServerUsageToCCSFilePath";
	...
	private static final Logger LOGGER_SERVICE_STREAMING = Logger.getLogger("serviceStreaming");
	private static final Logger LOGGER_SERVER_USAGE_CCS = Logger.getLogger("ServerUsageCCS");
	...
	public static void printServiceStreaming(final String format, final Object... args) {
		printf(LOGGER_SERVICE_STREAMING, DEFAULT_LEVEL, String.format(format, args));
	}

	public static void printServerToCCS(final String format, final Object... args) {
		printf(LOGGER_SERVER_USAGE_CCS, DEFAULT_LEVEL, String.format(format, args));
	}	
	/**
	...
	public static void configLogger(final Properties props) throws SecurityException, IOException {
		...
		final String serviceStreamingFileName = props.containsKey(FILE_SERVICE_STREAMING_PATH_PROP_KEY)
				? props.getProperty(FILE_SERVICE_STREAMING_PATH_PROP_KEY).toString() : null;
		final String serverToCCSFileName = props.containsKey(FILE_SERVER_USAGE_PATH_PROP_KEY)
				? props.getProperty(FILE_SERVER_USAGE_PATH_PROP_KEY).toString() : null;
		...
		LOGGER_SERVICE_STREAMING.setUseParentHandlers(false);
		LOGGER_SERVER_USAGE_CCS.setUseParentHandlers(false);
		...
		redirectToFile(LOGGER_SERVICE_STREAMING, serviceStreamingFileName);
		redirectToFile(LOGGER_SERVER_USAGE_CCS, serverToCCSFileName);
	}
	...
	public static void redirectToFile(final Logger logger, final String fileName, Boolean append) {
		...
		if (fileName != null) {
			System.err.println("Redirecting output to " + new File(fileName).getAbsolutePath());
		}
	...
	private static class CustomFormatter extends Formatter {
		...
		public String format(final LogRecord record) {
			...
			if (prefixReadableCloudSimClock) {
				result.append(TextUtil.getReadableTimeMs(CloudSim.clock()) + "\t");
			}
